  ...
  const onSubmit = async (data: PatientFormData) => {
    try {
      if (isEditing) {
        ...
        // Criando perfil do usuário (se não existir)
        const { data: profile, error: profileError } = await supabase
          .from("perfis")
          .insert({
            id: user.user.id, // Garantindo o vínculo com auth.users
        ...
        // Criando o paciente associado ao perfil
      ...
      toast.error(`Erro ao salvar paciente: ${error.message || error}`);
    }
  };
