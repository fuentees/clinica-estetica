...
import { QueryClient, QueryClientProvider } from "@tanstack/react-query"; // ✅ Adicionando QueryClientProvider corretamente
...
function App() {
  return (
    <QueryClientProvider client={queryClient}>
      {/* ✅ Englobando toda a aplicação com QueryClientProvider */}
      <Router>
        <ThemeProvider>
          <AuthProvider>
            <Toaster
    ...
    </QueryClientProvider> // ✅ Fechando corretamente o QueryClientProvider
  );
}
